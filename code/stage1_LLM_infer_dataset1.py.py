...
# ============================================================
# Dataset1 -> current CRC input adapter
# ============================================================
def build_dataset1_crc_input(
    source_records,
    inference_results,
    label2name,
):
    """
    Build an input JSON that can be passed directly to the current
    dataset1 CRC script.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Dataset1 structured Reasoning V1 and "
...
def main():
    ...
    performance["note"] = (
        "Dataset1 structured Reasoning V1 with "
